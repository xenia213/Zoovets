...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Добавить пациента</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
            @if (session('success'))
